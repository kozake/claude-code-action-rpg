...
const WAVES: WaveDef[] = [
  {
    message: '⚔ Wave 1: 前哨戦',
    enemies: [
      [14, 5, 'basic', 80, 75], [22, 8, 'basic', 80, 80],
      [9, 14, 'basic', 90, 75], [34, 4, 'basic', 80, 85],
      [27, 17, 'basic', 90, 70],
    ],
  },
  {
    ...
    enemies: [
      [38, 13, 'ranged', 100, 55], [42, 7, 'ranged', 100, 55],
      [30, 10, 'ranged', 110, 60], [18, 22, 'basic', 110, 85],
      [7, 20, 'basic', 120, 80], [46, 18, 'basic', 100, 90],
    ],
  },
  {
    message: '⚔ Wave 3: 突撃部隊',
    enemies: [
      [15, 6, 'charger', 130, 70], [35, 10, 'charger', 130, 70],
      [25, 20, 'bomber', 70, 90], [10, 15, 'bomber', 70, 90],
      [40, 15, 'ranged', 120, 60],
    ],
  },
  {
    message: '⚔ Wave 4: 精鋭部隊',
    enemies: [
      [20, 10, 'shield', 160, 55], [30, 15, 'shield', 160, 55],
      [12, 20, 'summoner', 180, 40], [38, 8, 'charger', 150, 75],
      [25, 5, 'ranged', 130, 60], [45, 20, 'bomber', 80, 95],
    ],
  },
  {
    message: '💀 Final Wave: 総攻撃',
    enemies: [
      [10, 8, 'charger', 150, 80], [40, 8, 'charger', 150, 80],
      [25, 12, 'summoner', 200, 45], [15, 18, 'shield', 180, 60],
      [35, 18, 'shield', 180, 60], [20, 24, 'bomber', 90, 100],
      [30, 24, 'bomber', 90, 100], [42, 22, 'ranged', 140, 65],
    ],
  },
];
